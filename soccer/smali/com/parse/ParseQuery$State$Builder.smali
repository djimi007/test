...
.method public constructor <init>(Lcom/parse/ParseQuery$State$Builder;)V
    ...
    iput v3, p0, Lcom/parse/ParseQuery$State$Builder;->limit:I

    const/4 v3, 0x0

    iput v3, p0, Lcom/parse/ParseQuery$State$Builder;->skip:I

    new-instance v4, Ljava/util/ArrayList;

    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V

    iput-object v4, p0, Lcom/parse/ParseQuery$State$Builder;->order:Ljava/util/List;

    sget-object v4, Lcom/parse/ParseQuery$CachePolicy;->IGNORE_CACHE:Lcom/parse/ParseQuery$CachePolicy;

    iput-object v4, p0, Lcom/parse/ParseQuery$State$Builder;->cachePolicy:Lcom/parse/ParseQuery$CachePolicy;

    const-wide v4, 0x7fffffffffffffffL

    iput-wide v4, p0, Lcom/parse/ParseQuery$State$Builder;->maxCacheAge:J

    iput-boolean v3, p0, Lcom/parse/ParseQuery$State$Builder;->isFromLocalDatastore:Z

    iget-object v3, p1, Lcom/parse/ParseQuery$State$Builder;->className:Ljava/lang/String;

    iput-object v3, p0, Lcom/parse/ParseQuery$State$Builder;->className:Ljava/lang/String;

    iget-object v3, p1, Lcom/parse/ParseQuery$State$Builder;->where:Lcom/parse/ParseQuery$QueryConstraints;

    invoke-virtual {v0, v3}, Ljava/util/HashMap;->putAll(Ljava/util/Map;)V

    iget-object v0, p1, Lcom/parse/ParseQuery$State$Builder;->includes:Ljava/util/Set;
    ...
    iget-object v0, p1, Lcom/parse/ParseQuery$State$Builder;->extraOptions:Ljava/util/Map;
    ...
    iget-boolean p1, p1, Lcom/parse/ParseQuery$State$Builder;->ignoreACLs:Z
...
.method public static or(Ljava/util/List;)Lcom/parse/ParseQuery$State$Builder;
    ...
    check-cast v2, Lcom/parse/ParseQuery$State$Builder;

    if-eqz v0, :cond_1

    iget-object v3, v2, Lcom/parse/ParseQuery$State$Builder;->className:Ljava/lang/String;
    ...
    const-string v0, "All of the queries in an or query must be on the same class "
    ...
    :cond_1
    :goto_1
    iget v0, v2, Lcom/parse/ParseQuery$State$Builder;->limit:I

    if-gez v0, :cond_6

    iget v0, v2, Lcom/parse/ParseQuery$State$Builder;->skip:I

    if-gtz v0, :cond_5

    iget-object v0, v2, Lcom/parse/ParseQuery$State$Builder;->order:Ljava/util/List;
    ...
    iget-object v0, v2, Lcom/parse/ParseQuery$State$Builder;->includes:Ljava/util/Set;
    ...
    iget-object v0, v2, Lcom/parse/ParseQuery$State$Builder;->selectedKeys:Ljava/util/Set;

    if-nez v0, :cond_2

    iget-object v0, v2, Lcom/parse/ParseQuery$State$Builder;->className:Ljava/lang/String;

    iget-object v2, v2, Lcom/parse/ParseQuery$State$Builder;->where:Lcom/parse/ParseQuery$QueryConstraints;
    ...
    const-string v0, "Cannot have an selectKeys in sub queries of an \'OR\' query"
    ...
    const-string v0, "Cannot have an include in sub queries of an \'OR\' query"
    ...
    const-string v0, "Cannot have an order in sub queries of an \'OR\' query"
    ...
    const-string v0, "Cannot have skips in sub queries of an \'OR\' query"
    ...
    const-string v0, "Cannot have limits in sub queries of an \'OR\' query"
    ...
    :cond_7
    new-instance p0, Lcom/parse/ParseQuery$State$Builder;

    invoke-direct {p0, v0}, Lcom/parse/ParseQuery$State$Builder;-><init>(Ljava/lang/String;)V

    invoke-direct {p0, v1}, Lcom/parse/ParseQuery$State$Builder;->whereSatifiesAnyOf(Ljava/util/List;)Lcom/parse/ParseQuery$State$Builder;
...
.method clear(Ljava/lang/String;)Lcom/parse/ParseQuery$State$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public getCachePolicy()Lcom/parse/ParseQuery$CachePolicy;
    ...
    invoke-static {}, Lcom/parse/ParseQuery;->access$1800()V
...
.method public whereDoesNotMatchKeyInQuery(Ljava/lang/String;Ljava/lang/String;Lcom/parse/ParseQuery$State$Builder;)Lcom/parse/ParseQuery$State$Builder;
    ...
    const-string p3, "$dontSelect"

    invoke-direct {p0, p1, p3, p2}, Lcom/parse/ParseQuery$State$Builder;->addConditionInternal(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)Lcom/parse/ParseQuery$State$Builder;
...
.method public whereGeoIntersects(Ljava/lang/String;Lcom/parse/ParseGeoPoint;)Lcom/parse/ParseQuery$State$Builder;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string p2, "$geoIntersects"

    invoke-virtual {p0, p1, p2, v0}, Lcom/parse/ParseQuery$State$Builder;->addCondition(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)Lcom/parse/ParseQuery$State$Builder;
...
.method public whereGeoWithin(Ljava/lang/String;Ljava/util/List;)Lcom/parse/ParseQuery$State$Builder;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method whereRelatedTo(Lcom/parse/ParseObject;Ljava/lang/String;)Lcom/parse/ParseQuery$State$Builder;
    ...
    new-instance v1, Lcom/parse/ParseQuery$RelationConstraint;

    invoke-direct {v1, p2, p1}, Lcom/parse/ParseQuery$RelationConstraint;-><init>(Ljava/lang/String;Lcom/parse/ParseObject;)V

    const-string p1, "$relatedTo"
...
.method public whereText(Ljava/lang/String;Ljava/lang/String;)Lcom/parse/ParseQuery$State$Builder;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2, v1}, Lcom/parse/ParseQuery$State$Builder;->addCondition(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)Lcom/parse/ParseQuery$State$Builder;
