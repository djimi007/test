...
.method static maybeAddTransition(LlILLl1lI1l1/ILILliIIIllIi/LII1lIii1LLL;LlILLl1lI1l1/ILILliIIIllIi/Oo0;)V
    .locals 0
    ...
    invoke-virtual {p0, p1}, LlILLl1lI1l1/ILILliIIIllIi/LII1lIii1LLL;->OO0O0O0O0OOOO(LlILLl1lI1l1/ILILliIIIllIi/Oo0;)LlILLl1lI1l1/ILILliIIIllIi/LII1lIii1LLL;

    :cond_0
    return-void
.end method

.method static maybeApplyThemeDuration(LlILLl1lI1l1/ILILliIIIllIi/Oo0;Landroid/content/Context;I)Z
    .locals 5
    .param p2    # I
        .annotation build Landroidx/annotation/ooO0O0Oo;
        .end annotation
    ...
    invoke-virtual {p0, p1, p2}, LlILLl1lI1l1/ILILliIIIllIi/Oo0;->setDuration(J)LlILLl1lI1l1/ILILliIIIllIi/Oo0;
...
.method static maybeApplyThemeInterpolator(LlILLl1lI1l1/ILILliIIIllIi/Oo0;Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Z
    .locals 1
    .param p2    # I
        .annotation build Landroidx/annotation/ooO0O0Oo;
        .end annotation
...
.method static maybeApplyThemePath(LlILLl1lI1l1/ILILliIIIllIi/Oo0;Landroid/content/Context;I)Z
    .locals 0
    .param p2    # I
        .annotation build Landroidx/annotation/ooO0O0Oo;
        .end annotation
    ...
    invoke-static {p1, p2}, Lcom/google/android/material/transition/TransitionUtils;->resolveThemePath(Landroid/content/Context;I)LlILLl1lI1l1/ILILliIIIllIi/lLI1LlL;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, LlILLl1lI1l1/ILILliIIIllIi/Oo0;->setPathMotion(LlILLl1lI1l1/ILILliIIIllIi/lLI1LlL;)V
...
.method static maybeRemoveTransition(LlILLl1lI1l1/ILILliIIIllIi/LII1lIii1LLL;LlILLl1lI1l1/ILILliIIIllIi/Oo0;)V
    .locals 0
    .param p1    # LlILLl1lI1l1/ILILliIIIllIi/Oo0;
        .annotation build Landroidx/annotation/OOOO;
        .end annotation
    ...
    invoke-virtual {p0, p1}, LlILLl1lI1l1/ILILliIIIllIi/LII1lIii1LLL;->l1iLL11I(LlILLl1lI1l1/ILILliIIIllIi/Oo0;)LlILLl1lI1l1/ILILliIIIllIi/LII1lIii1LLL;
...
.method static resolveThemeInterpolator(Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p2, v0, v1, p0}, LlILLl1lI1l1/OO0O0O0O0OOOO/lii11l1lLL/IIll1IIlL/II1iI;->II1iI(FFFF)Landroid/view/animation/Interpolator;
    ...
    invoke-static {p0}, LlILLl1lI1l1/OO0O0O0O0OOOO/oo0OOo00ooo/OO0O0O0O0OOOO;->O0oOo00oOO(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object p0

    invoke-static {p0}, LlILLl1lI1l1/OO0O0O0O0OOOO/lii11l1lLL/IIll1IIlL/II1iI;->lIlL(Landroid/graphics/Path;)Landroid/view/animation/Interpolator;
...
.method static resolveThemePath(Landroid/content/Context;I)LlILLl1lI1l1/ILILliIIIllIi/lLI1LlL;
    .locals 3
    .param p1    # I
        .annotation build Landroidx/annotation/ooO0O0Oo;
        .end annotation
    ...
    new-instance p1, LlILLl1lI1l1/ILILliIIIllIi/L1iLlii11LLl;

    invoke-static {p0}, LlILLl1lI1l1/OO0O0O0O0OOOO/oo0OOo00ooo/OO0O0O0O0OOOO;->O0oOo00oOO(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object p0

    invoke-direct {p1, p0}, LlILLl1lI1l1/ILILliIIIllIi/L1iLlii11LLl;-><init>(Landroid/graphics/Path;)V
