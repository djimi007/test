...
# instance fields
.field private checkedItem:Landroidx/appcompat/view/menu/O0O00O;
...
.method private prepareMenuItems()V
    ...
    iget-object v3, v3, Lcom/google/android/material/internal/NavigationMenuPresenter;->menu:Landroidx/appcompat/view/menu/OOoo0;
    ...
    iget-object v8, v8, Lcom/google/android/material/internal/NavigationMenuPresenter;->menu:Landroidx/appcompat/view/menu/OOoo0;

    invoke-virtual {v8}, Landroidx/appcompat/view/menu/OOoo0;->getVisibleItems()Ljava/util/ArrayList;
    ...
    check-cast v8, Landroidx/appcompat/view/menu/O0O00O;

    invoke-virtual {v8}, Landroidx/appcompat/view/menu/O0O00O;->isChecked()Z

    move-result v9

    if-eqz v9, :cond_1

    invoke-virtual {v0, v8}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->setCheckedItem(Landroidx/appcompat/view/menu/O0O00O;)V

    :cond_1
    invoke-virtual {v8}, Landroidx/appcompat/view/menu/O0O00O;->isCheckable()Z

    move-result v9

    if-eqz v9, :cond_2

    invoke-virtual {v8, v4}, Landroidx/appcompat/view/menu/O0O00O;->Oooo00oO00o0o(Z)V

    :cond_2
    invoke-virtual {v8}, Landroidx/appcompat/view/menu/O0O00O;->hasSubMenu()Z

    move-result v9

    if-eqz v9, :cond_9

    invoke-virtual {v8}, Landroidx/appcompat/view/menu/O0O00O;->getSubMenu()Landroid/view/SubMenu;
    ...
    invoke-direct {v11, v8}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Landroidx/appcompat/view/menu/O0O00O;)V
    ...
    invoke-virtual {v14}, Landroidx/appcompat/view/menu/O0O00O;->isVisible()Z
    ...
    invoke-virtual {v14}, Landroidx/appcompat/view/menu/O0O00O;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    invoke-virtual {v14}, Landroidx/appcompat/view/menu/O0O00O;->isCheckable()Z

    move-result v15

    if-eqz v15, :cond_5

    invoke-virtual {v14, v4}, Landroidx/appcompat/view/menu/O0O00O;->Oooo00oO00o0o(Z)V
    ...
    invoke-direct {v1, v14}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Landroidx/appcompat/view/menu/O0O00O;)V
    ...
    :cond_9
    invoke-virtual {v8}, Landroidx/appcompat/view/menu/O0O00O;->getGroupId()I
    ...
    invoke-virtual {v8}, Landroidx/appcompat/view/menu/O0O00O;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v2, v8}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Landroidx/appcompat/view/menu/O0O00O;)V
...
.method public createInstanceState()Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->checkedItem:Landroidx/appcompat/view/menu/O0O00O;
    ...
    invoke-virtual {v4}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Landroidx/appcompat/view/menu/O0O00O;

    move-result-object v4

    if-eqz v4, :cond_1

    invoke-virtual {v4}, Landroidx/appcompat/view/menu/O0O00O;->getActionView()Landroid/view/View;
...
.method public getCheckedItem()Landroidx/appcompat/view/menu/O0O00O;
    .locals 1

    iget-object v0, p0, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->checkedItem:Landroidx/appcompat/view/menu/O0O00O;
...
.method public getItemViewType(I)I
    ...
    invoke-virtual {p1}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Landroidx/appcompat/view/menu/O0O00O;
...
.method public onBindViewHolder(Lcom/google/android/material/internal/NavigationMenuPresenter$ViewHolder;I)V
    ...
    invoke-virtual {p2}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Landroidx/appcompat/view/menu/O0O00O;

    move-result-object p2

    invoke-virtual {p2}, Landroidx/appcompat/view/menu/O0O00O;->getTitle()Ljava/lang/CharSequence;
    ...
    :goto_0
    invoke-static {p1, v0}, LlILLl1lI1l1/OO0O0O0O0OOOO/lii11l1lLL/oO;->Oo(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p1, p2, v1}, Lcom/google/android/material/internal/NavigationMenuItemView;->initialize(Landroidx/appcompat/view/menu/O0O00O;I)V
...
.method public restoreInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v4}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->setCheckedItem(Landroidx/appcompat/view/menu/O0O00O;)V
    ...
    invoke-virtual {v2}, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Landroidx/appcompat/view/menu/O0O00O;
    ...
    :cond_4
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/O0O00O;->getActionView()Landroid/view/View;
...
.method public setCheckedItem(Landroidx/appcompat/view/menu/O0O00O;)V
    .locals 2
    .param p1    # Landroidx/appcompat/view/menu/O0O00O;
        .annotation build Landroidx/annotation/ooo0OoOO0OoO;
        .end annotation
    .end param
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/O0O00O;->setChecked(Z)Landroid/view/MenuItem;

    :cond_1
    iput-object p1, p0, Lcom/google/android/material/internal/NavigationMenuPresenter$NavigationMenuAdapter;->checkedItem:Landroidx/appcompat/view/menu/O0O00O;

    const/4 v0, 0x1

    invoke-virtual {p1, v0}, Landroidx/appcompat/view/menu/O0O00O;->setChecked(Z)Landroid/view/MenuItem;
...
.method public update()V
    ...
    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView$OOoo0;->notifyDataSetChanged()V
