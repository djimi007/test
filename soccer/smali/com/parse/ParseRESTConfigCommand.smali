...
.method public static updateConfigCommand(Ljava/util/Map;Ljava/lang/String;)Lcom/parse/ParseRESTConfigCommand;
    ...
    :goto_0
    new-instance p0, Lcom/parse/ParseRESTConfigCommand;

    sget-object v1, Lcom/parse/http/ParseHttpRequest$Method;->PUT:Lcom/parse/http/ParseHttpRequest$Method;

    const-string v2, "config"

    invoke-direct {p0, v2, v1, v0, p1}, Lcom/parse/ParseRESTConfigCommand;-><init>(Ljava/lang/String;Lcom/parse/http/ParseHttpRequest$Method;Ljava/util/Map;Ljava/lang/String;)V
