...
# direct methods
.method constructor <init>(Lcom/parse/boltsinternal/TaskCompletionSource;Landroid/location/LocationManager;Landroid/location/LocationListener;)V
    .locals 0

    iput-object p1, p0, Lcom/parse/LocationNotifier$2;->val$tcs:Lcom/parse/boltsinternal/TaskCompletionSource;
...
.method public run()V
    ...
    iget-object v0, p0, Lcom/parse/LocationNotifier$2;->val$tcs:Lcom/parse/boltsinternal/TaskCompletionSource;
    ...
    invoke-virtual {v0, v1}, Lcom/parse/boltsinternal/TaskCompletionSource;->trySetError(Ljava/lang/Exception;)Z
