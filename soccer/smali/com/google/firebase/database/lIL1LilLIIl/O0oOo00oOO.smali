.class public Lcom/google/firebase/database/lIL1LilLIIl/O0oOo00oOO;
...
# instance fields
.field private final lIlL:Ljava/util/ArrayDeque;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method constructor <init>(Lcom/google/firebase/database/lIL1LilLIIl/iLLiliLI;Ljava/lang/Object;Ljava/util/Comparator;Z)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lcom/google/firebase/database/lIL1LilLIIl/O0oOo00oOO;->lIlL:Ljava/util/ArrayDeque;

    iput-boolean p4, p0, Lcom/google/firebase/database/lIL1LilLIIl/O0oOo00oOO;->oo0OOo00ooo:Z
    ...
    iget-object p2, p0, Lcom/google/firebase/database/lIL1LilLIIl/O0oOo00oOO;->lIlL:Ljava/util/ArrayDeque;

    check-cast p1, Lcom/google/firebase/database/lIL1LilLIIl/ILIi1lLIl1l1l;
    ...
    :cond_5
    iget-object v0, p0, Lcom/google/firebase/database/lIL1LilLIIl/O0oOo00oOO;->lIlL:Ljava/util/ArrayDeque;
...
.method public lILLl1lI1l1()Ljava/util/Map$Entry;
    ...
    invoke-virtual {v0}, Lcom/google/firebase/database/lIL1LilLIIl/ILIi1lLIl1l1l;->getKey()Ljava/lang/Object;

    move-result-object v2

    invoke-virtual {v0}, Lcom/google/firebase/database/lIL1LilLIIl/ILIi1lLIl1l1l;->getValue()Ljava/lang/Object;

    move-result-object v3

    invoke-direct {v1, v2, v3}, Ljava/util/AbstractMap$SimpleEntry;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    iget-boolean v2, p0, Lcom/google/firebase/database/lIL1LilLIIl/O0oOo00oOO;->oo0OOo00ooo:Z
    ...
    iget-object v2, p0, Lcom/google/firebase/database/lIL1LilLIIl/O0oOo00oOO;->lIlL:Ljava/util/ArrayDeque;

    move-object v3, v0

    check-cast v3, Lcom/google/firebase/database/lIL1LilLIIl/ILIi1lLIl1l1l;
...
.method public bridge synthetic next()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/google/firebase/database/lIL1LilLIIl/O0oOo00oOO;->lILLl1lI1l1()Ljava/util/Map$Entry;
