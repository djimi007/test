...
.method static synthetic access$000(Lcom/parse/ParseUser;)Lcom/parse/boltsinternal/Task;
    .locals 0
...
.method static synthetic access$100(Lcom/parse/ParseUser;Ljava/lang/String;)Ljava/util/Map;
    .locals 0
...
.method static synthetic access$200(Lcom/parse/ParseUser;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic access$400(Lcom/parse/ParseUser;)V
    .locals 0
...
.method static synthetic access$500(Lcom/parse/ParseUser;Ljava/lang/String;Ljava/util/Map;Lcom/parse/boltsinternal/Task;Ljava/lang/String;)Lcom/parse/boltsinternal/Task;
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/parse/ParseUser;->linkWithAsync(Ljava/lang/String;Ljava/util/Map;Lcom/parse/boltsinternal/Task;Ljava/lang/String;)Lcom/parse/boltsinternal/Task;
...
.method static synthetic access$600(Lcom/parse/ParseUser;Lcom/parse/boltsinternal/Task;)Lcom/parse/boltsinternal/Task;
    .locals 0

    invoke-direct {p0, p1}, Lcom/parse/ParseUser;->upgradeToRevocableSessionAsync(Lcom/parse/boltsinternal/Task;)Lcom/parse/boltsinternal/Task;
...
.method static synthetic access$700(Lcom/parse/ParseUser;Ljava/lang/String;)Lcom/parse/boltsinternal/Task;
    .locals 0

    invoke-direct {p0, p1}, Lcom/parse/ParseUser;->setSessionTokenInBackground(Ljava/lang/String;)Lcom/parse/boltsinternal/Task;
...
.method public static become(Ljava/lang/String;)Lcom/parse/ParseUser;
    ...
    invoke-static {p0}, Lcom/parse/ParseUser;->becomeInBackground(Ljava/lang/String;)Lcom/parse/boltsinternal/Task;
...
.method public static becomeInBackground(Ljava/lang/String;)Lcom/parse/boltsinternal/Task;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v0, p0}, Lcom/parse/ParseUserController;->getUserAsync(Ljava/lang/String;)Lcom/parse/boltsinternal/Task;
...
.method static disableAutomaticUser()V
    ...
    :try_start_0
    sput-boolean v1, Lcom/parse/ParseUser;->autoUserEnabled:Z
...
.method public static enableRevocableSessionInBackground()Lcom/parse/boltsinternal/Task;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v0, v1}, Lcom/parse/ParseCurrentUserController;->getAsync(Z)Lcom/parse/boltsinternal/Task;

    move-result-object v0

    new-instance v1, Lcom/parse/ParseUser$5;

    invoke-direct {v1}, Lcom/parse/ParseUser$5;-><init>()V
...
.method static getCurrentUserAsync()Lcom/parse/boltsinternal/Task;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method private linkWithAsync(Ljava/lang/String;Ljava/util/Map;Lcom/parse/boltsinternal/Task;Ljava/lang/String;)Lcom/parse/boltsinternal/Task;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p4, v1, p3}, Lcom/parse/ParseUser;->saveAsync(Ljava/lang/String;ZLcom/parse/boltsinternal/Task;)Lcom/parse/boltsinternal/Task;

    move-result-object p2

    new-instance p3, Lcom/parse/ParseUser$15;

    invoke-direct {p3, p0, p1, v2}, Lcom/parse/ParseUser$15;-><init>(Lcom/parse/ParseUser;Ljava/lang/String;Ljava/util/Map;)V
...
.method private linkWithAsync(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;)Lcom/parse/boltsinternal/Task;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lcom/parse/ParseUser$16;-><init>(Lcom/parse/ParseUser;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;)V
...
.method public static logInInBackground(Ljava/lang/String;Ljava/lang/String;)Lcom/parse/boltsinternal/Task;
    ...
    new-instance p1, Lcom/parse/ParseUser$1;

    invoke-direct {p1}, Lcom/parse/ParseUser$1;-><init>()V
...
.method public static logInWithInBackground(Ljava/lang/String;Ljava/util/Map;)Lcom/parse/boltsinternal/Task;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Lcom/parse/ParseUser$3;-><init>(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-interface {v1, v2}, Lcom/parse/ParseCurrentUserController;->getAsync(Z)Lcom/parse/boltsinternal/Task;

    move-result-object v1

    new-instance v2, Lcom/parse/ParseUser$4;

    invoke-direct {v2, p0, p1, v0}, Lcom/parse/ParseUser$4;-><init>(Ljava/lang/String;Ljava/util/Map;Lcom/parse/boltsinternal/Continuation;)V
...
.method static pinCurrentUserIfNeededAsync(Lcom/parse/ParseUser;)Lcom/parse/boltsinternal/Task;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private setSessionTokenInBackground(Ljava/lang/String;)Lcom/parse/boltsinternal/Task;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1}, Lcom/parse/ParseUser;->setState(Lcom/parse/ParseObject$State;)V
...
.method private upgradeToRevocableSessionAsync(Lcom/parse/boltsinternal/Task;)Lcom/parse/boltsinternal/Task;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v0, Lcom/parse/ParseUser$19;

    invoke-direct {v0, p0}, Lcom/parse/ParseUser$19;-><init>(Lcom/parse/ParseUser;)V
...
# virtual methods
.method cleanUpAuthDataAsync()Lcom/parse/boltsinternal/Task;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public linkWithInBackground(Ljava/lang/String;Ljava/util/Map;)Lcom/parse/boltsinternal/Task;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/parse/ParseUser;->linkWithAsync(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;)Lcom/parse/boltsinternal/Task;
...
.method logOutAsync()Lcom/parse/boltsinternal/Task;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method logOutAsync(Z)Lcom/parse/boltsinternal/Task;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z)",
...
.method public remove(Ljava/lang/String;)V
    ...
    const-string v0, "Can\'t remove the username key."
...
.method resolveLazinessAsync(Lcom/parse/boltsinternal/Task;)Lcom/parse/boltsinternal/Task;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method saveAsync(Ljava/lang/String;ZLcom/parse/boltsinternal/Task;)Lcom/parse/boltsinternal/Task;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method signUpAsync(Lcom/parse/boltsinternal/Task;)Lcom/parse/boltsinternal/Task;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public signUpInBackground()Lcom/parse/boltsinternal/Task;
    ...
    invoke-direct {v1, p0}, Lcom/parse/ParseUser$11;-><init>(Lcom/parse/ParseUser;)V
...
.method synchronizeAllAuthDataAsync()Lcom/parse/boltsinternal/Task;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method synchronizeAuthDataAsync(Ljava/lang/String;)Lcom/parse/boltsinternal/Task;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method upgradeToRevocableSessionAsync()Lcom/parse/boltsinternal/Task;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
